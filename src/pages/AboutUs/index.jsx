    ...
    <div className="content-aboutus">
      ...
      <div className="texto-principal">
        ...
        Explore nosso portfólio de propriedades e descubra um novo nível de excelência em imóveis de alto padrão. Seja parte da nossa história de sucesso na busca pelo lar perfeito.
          <br />
          <br />
        Entre em contato conosco para começar sua jornada rumo à realização dos seus sonhos imobiliários.
        Descubra o luxo, a sofisticação e o conforto que esperam por você na Habitex.</p>
        ...
        <button className='contact' href="https://api.whatsapp.com/send/?phone=5511977377113&text=Bom+dia%2C+poderiam+me+apresentar+alguns+im%C3%B3veis%3F&type=phone_number&app_absent=0">Fale Conosco ❯ </button>
        </a>
      </div>
    </div>
